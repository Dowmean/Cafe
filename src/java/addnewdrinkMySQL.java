...
public class addnewdrinkMySQL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String adds[] = request.getParameterValues("adds");
        ...
        drink.setAdds(adds);
        drink.setSweet(sweet);
        drink.setPrice(price);

        // insert into MySQL: table food
        DBConnection dbConnection = new DBConnection();
        if(!dbConnection.insertNewDrink(drink)){
            System.out.println(">>> addnewdrinkdMySQL ERROR");
        }
        ...
        RequestDispatcher rd = sc.getRequestDispatcher("/addnewdrinksuccess.jsp");
